...
| `make_quality_gradient_figure.py` | Manuscript Figure 2: ten images spanning the quality score range from one capture event for each of the three best-sampled individuals | `results/quality_gradient.png` |
