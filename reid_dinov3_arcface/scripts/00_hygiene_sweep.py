#!/usr/bin/env python3
"""
Script 00: Gallery Hygiene Sweep - DINOv3 + ArcFace

Replicates reid_hygiene_filter experimental design but uses ArcFace loss
instead of triplet loss for metric learning.

Key differences from reid_hygiene_filter:
- Loss: ArcFaceLoss instead of TripletMarginLoss
- Training: Classification loss instead of triplet mining
...
def main():
    parser = argparse.ArgumentParser(description='DINOv3 + ArcFace Gallery Hygiene Sweep')
    ...
    print("=" * 80)
    print(f"DINOv3 + ArcFace Gallery Hygiene Sweep - Job {args.idx}")
    print("=" * 80)
