#!/usr/bin/env python3
"""
Script 01: Plot Open-Set Hygiene Sweep Results
...
C) Closed-set Recall@1 (same as reid_dinov3_arcface for comparison)
"""
...
def plot_recall_strategies(results: ResultsCollection, output_path: str):
    ...
    ax.set_title('Closed-Set Evaluation: Known Individual Re-ID', fontsize=16)
    ax.set_xticks(gallery_sizes)
...
def plot_validation_loss_curves(results: ResultsCollection, output_path: str):
    ...
    fig.suptitle('Validation Loss by Configuration (ArcFace)', fontsize=14, y=1.01)
...
def main():
    parser = argparse.ArgumentParser(description='Plot Open-Set hygiene sweep results')
    parser.add_argument('--results_dir', type=str,
                        default='reid_openset_arcface/results',
                        help='Directory containing result JSON files')
    parser.add_argument('--output_dir', type=str,
                        default='reid_openset_arcface/figures',
    ...
    print("=" * 60)
    print("Open-Set Evaluation: Gallery Hygiene Sweep Results Analysis")
    print("=" * 60)
