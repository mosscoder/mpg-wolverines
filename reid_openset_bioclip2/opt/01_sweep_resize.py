#!/usr/bin/env python3
"""
Script 01: Image Size Sweep for BioCLIP-2 Re-ID with Temporal (ymdh) Split
...
def train_single_resize(resize_size: int, args, dataset, config, metadata_cache) -> dict:
    ...
    transform = create_bioclip2_transform(size=resize_size)
...
def main():
    ...
    print("=" * 80)
    print(f"Image Size Sweep - BioCLIP-2 Re-ID with Temporal Split - Job {args.idx}")
    print("=" * 80)
